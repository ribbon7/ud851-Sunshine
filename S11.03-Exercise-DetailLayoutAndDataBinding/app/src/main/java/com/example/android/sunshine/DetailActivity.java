...
//  TODO (2) Remove all the TextView declarations
     ...
     */
//  TODO (3) Declare an ActivityDetailBinding field called m
...
//      TODO (7) Display the weather icon using mDetailBinding
        int conditionId = data.getInt(INDEX_WEATHER_CONDITION_ID);
        int imageId = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(conditionId);

        mDetailBinding.primaryWeatherInfo.detailsWeatherIcon.setImageResource(imageId);
...
//      TODO (8) Use mDetailBinding to display the date
        mDetailBinding.primaryWeatherInfo.detailsDate.setText(dateText);
...
//      TODO (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.detailsWeatherDescription.setText(description);
...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.detailsHighTemperature.setText(highString);
...
//      TODO (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.detailsLowTemperature.setText(lowString);
...
//      TODO (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraWeatherDetails.detailsHumidity.setText(humidityString);
...
//      TODO (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraWeatherDetails.detailsWind.setText(windString);
...
//      TODO (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraWeatherDetails.detailsPressure.setText(pressureString);
