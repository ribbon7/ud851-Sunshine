...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String defaultMetricValue = context.getString(R.string.pref_units_metric);
        String units = sharedPreferences.getString(key, defaultMetricValue);
        if (units.equals(defaultMetricValue)) {
            return true;
        } else {
            return false;
        }
